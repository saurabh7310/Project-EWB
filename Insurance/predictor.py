...
from Insurance.entity.config_entity import TRANSFORMER_OBJECT_FILE_NAME, MODEL_FILE_NAME
from Insurance.entity.config_entity import TARGET_ENCODER_OBJECT_FILE_NAME, MODEL_FILE_NAME



# Folder (new model saver)
# comparison new model vs old model
# Acepted else Rejected
...
class ModelResolver:
    ...
    def get_letest_model_path(self):
        try:
